function [best_pinkgreen, count_pinkgreen] = findPinkGreenCircles(ImPatch, pinkThreshold, greenThreshold)
    ...
    [best_pinkgreen, count_pinkgreen, dist_pinkgreen] = findTemplatesInImage(ImPatch, temps_pinkgreen, thresh_pinkgreen);
